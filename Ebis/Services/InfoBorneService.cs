       ...
       public Borne GetBorne(int idBorne)
        {
            ...
            var Borne = new MySqlCommand("SELECT idBorne, date_mise_en_service, date_derniere_revision, libelle_type_charge  FROM ebis_project.borne join type_charge on borne.fk_type_charge = code_type_charge where idBorne =  " + idBorne, connection);
